...
public enum InventoryType {
    ...
    CRAFTER_3X3(new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 7, 9)),
    ...
    ANVIL(new InventoryProtocolIdMapping(MINECRAFT_1_8, MINECRAFT_1_13_2, "minecraft:anvil", 3), new InventoryProtocolIdMapping(MINECRAFT_1_14, MINECRAFT_1_20_2, 7, 3), new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 8, 3)),
    BEACON(new InventoryProtocolIdMapping(MINECRAFT_1_8, MINECRAFT_1_13_2, "minecraft:beacon", 1), new InventoryProtocolIdMapping(MINECRAFT_1_14, MINECRAFT_1_20_2, 8, 1), new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 9, 1)),
    BLAST_FURNACE(new InventoryProtocolIdMapping(MINECRAFT_1_14, MINECRAFT_1_20_2, 9, 2), new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 10, 2)),
    BREWING_STAND(new InventoryProtocolIdMapping(MINECRAFT_1_8, MINECRAFT_1_8, "minecraft:brewing_stand", 4), new InventoryProtocolIdMapping(MINECRAFT_1_9, MINECRAFT_1_13_2, "minecraft:brewing_stand", 5), new InventoryProtocolIdMapping(MINECRAFT_1_14, MINECRAFT_1_20_2, 10, 5), new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 11, 5)),
    CRAFTING(new InventoryProtocolIdMapping(MINECRAFT_1_8, MINECRAFT_1_13_2, "minecraft:crafting_table", 10), new InventoryProtocolIdMapping(MINECRAFT_1_14, MINECRAFT_1_20_2, 11, 10), new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 12, 10)),
    ENCHANTMENT(new InventoryProtocolIdMapping(MINECRAFT_1_8, MINECRAFT_1_13_2, "minecraft:enchanting_table", 2), new InventoryProtocolIdMapping(MINECRAFT_1_14, MINECRAFT_1_20_2, 12, 2), new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 13, 2)),
    FURNACE(new InventoryProtocolIdMapping(MINECRAFT_1_8, MINECRAFT_1_13_2, "minecraft:furnace", 3), new InventoryProtocolIdMapping(MINECRAFT_1_14, MINECRAFT_1_20_2, 13, 3), new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 14, 3)),
    GRINDSTONE(new InventoryProtocolIdMapping(MINECRAFT_1_14, MINECRAFT_1_20_2, 14, 3), new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 15, 3)),
    HOPPER(new InventoryProtocolIdMapping(MINECRAFT_1_8, MINECRAFT_1_13_2, "minecraft:hopper", 5), new InventoryProtocolIdMapping(MINECRAFT_1_14, MINECRAFT_1_20_2, 15, 5), new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 16, 5)),
    LECTERN(new InventoryProtocolIdMapping(MINECRAFT_1_14, MINECRAFT_1_20_2, 16, 0), new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 17, 0)),
    LOOM(new InventoryProtocolIdMapping(MINECRAFT_1_14, MINECRAFT_1_20_2, 17, 4), new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 18, 4)),
    MERCHANT(new InventoryProtocolIdMapping(MINECRAFT_1_8, MINECRAFT_1_13_2, "minecraft:villager", 3), new InventoryProtocolIdMapping(MINECRAFT_1_14, MINECRAFT_1_20_2, 18, 3), new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 19, 3)),
    SHULKER_BOX(new InventoryProtocolIdMapping(MINECRAFT_1_9, MINECRAFT_1_13_2, "minecraft:shulker_box", 27), new InventoryProtocolIdMapping(MINECRAFT_1_14, MINECRAFT_1_20_2, 19, 27), new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 20, 27)),
    SMITHING(new InventoryProtocolIdMapping(MINECRAFT_1_14, MINECRAFT_1_20_2, 20, 3), new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 21, 3)),
    SMOKER(new InventoryProtocolIdMapping(MINECRAFT_1_14, MINECRAFT_1_20_2, 21, 3), new InventoryProtocolIdMapping(MINECRAFT_1_20_3, MINECRAFT_LATEST, 22, 3)),
