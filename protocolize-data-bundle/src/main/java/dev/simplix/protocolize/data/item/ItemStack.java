...
/**
 * This class represents a Minecraft item stack.
 * <br><br>
 * Date: 24.08.2021
 *
...
public class ItemStack {
    ...
    public <T> List<T> lore(boolean legacyString) {
        ...
        for (String line : loreJson) {
            if (legacyString) {
                out.add((T) CONVERTER.toLegacyText(CONVERTER.fromJson(displayNameJson)));
            } else {
                out.add((T) CONVERTER.fromJson(displayNameJson));
            }
        }
        return out;
    }
