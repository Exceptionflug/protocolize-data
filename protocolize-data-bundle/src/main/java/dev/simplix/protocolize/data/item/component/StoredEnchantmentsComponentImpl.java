...
/* Stored enchantments is sharing the EnchantmentsComponent class as they are identical (for now) */
@Data
@AllArgsConstructor
public class StoredEnchantmentsComponentImpl implements EnchantmentsComponent {
